...
class nn:
    ...
    def conv2d(self, in_planes: int, out_planes: int, kernel_size: int, activation: str, stride: int = 1,
               padding: int = 0) -> None:
        '''
    ...
    def conv_forward(self, A_prev: ndarray, W: ndarray, b: ndarray, hyper_param: List[int]) -> Tuple[
        ndarray, Tuple[ndarray, ndarray, ndarray, List[int]]]:
        """
    ...
    def conv_backward(self, dZ: ndarray, cache: Tuple[ndarray, ndarray, ndarray, List[int]]) -> Tuple[
